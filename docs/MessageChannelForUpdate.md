...
message_channel_for_update_instance = MessageChannelForUpdate.from_json(json)
# print the JSON string representation of the object
print(MessageChannelForUpdate.to_json())

# convert the object into a dict
message_channel_for_update_dict = message_channel_for_update_instance.to_dict()
# create an instance of MessageChannelForUpdate from a dict
message_channel_for_update_from_dict = MessageChannelForUpdate.from_dict(message_channel_for_update_dict)
```
