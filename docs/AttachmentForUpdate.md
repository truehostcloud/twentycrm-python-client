...
json = "{}"
# create an instance of AttachmentForUpdate from a JSON string
attachment_for_update_instance = AttachmentForUpdate.from_json(json)
# print the JSON string representation of the object
print(AttachmentForUpdate.to_json())

# convert the object into a dict
attachment_for_update_dict = attachment_for_update_instance.to_dict()
# create an instance of AttachmentForUpdate from a dict
attachment_for_update_from_dict = AttachmentForUpdate.from_dict(attachment_for_update_dict)
```
